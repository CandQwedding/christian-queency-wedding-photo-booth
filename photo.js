...
const HASHTAG = '#ChristianCenFoundhisQueenCy';
...
function makeFinalImage() {
  ...
  ctx.strokeRect(border/2, border/2, vw-border, vh-border);

  ctx.strokeStyle = 'rgba(74,48,36,.75)';
  ctx.lineWidth = Math.max(2, Math.round(vw * 0.002));
  ctx.strokeRect(border*1.45, border*1.45, vw-border*2.9, vh-border*2.9);
