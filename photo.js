...
const video=document.getElementById('cameraVideo'),captured=document.getElementById('capturedPhoto'),booth=document.getElementById('photoBooth'),message=document.getElementById('cameraMessage'),countdown=document.getElementById('countdown'),startBtn=document.getElementById('startCamera'),switchBtn=document.getElementById('switchCamera'),captureBtn=document.getElementById('captureButton'),previewActions=document.getElementById('previewActions'),redoBtn=document.getElementById('redoButton'),submitBtn=document.getElementById('submitButton'),status=document.getElementById('photoStatus');
...
startBtn.addEventListener('click',startCamera);switchBtn.addEventListener('click',async()=>{facingMode=facingMode==='user'?'environment':'user';await startCamera()});captureBtn.addEventListener('click',capturePhoto);redoBtn.addEventListener('click',redoPhoto);submitBtn.addEventListener('click',submitPhoto);window.addEventListener('pagehide',stopCamera);
